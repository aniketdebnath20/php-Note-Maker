...
if($result){
echo "the record was succesfully inserted! <br>";
$insert = true;
}
else {
echo "the record was not inserted succesful" . mysqli_error($conn);
}
  }
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="//cdn.datatables.net/2.1.2/css/dataTables.dataTables.min.css" class="css">
...
<boby>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="/Project iNote Php/index.php" method="POST">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary col-md-7">Save changes</button>
                        </div>
                    </form>
  ...
  echo "
  <div class='alert alert-success alert-dismissible fade show' role='alert'>
    <strong> Success!</strong> Your Note has been delete.
    <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
  </div>" ;
  }
  ?>
  ...
  ?>
    ...
    <div class="container my-5">
        ...
        <form action="/Project iNote Php/index.php" method="POST">
            ...
            <button type="submit" class="btn btn-primary col-md-7">Submit</button>
        </form>
        ...
        Array.from(deletes).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                if (confirm("press a button!")) {
                    console.log("yes");
                    window.location = `/Project iNote Php?delete=${srno}`;
                }
                else {
                    console.log("no");
                }
